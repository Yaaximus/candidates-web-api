...
def main(args):
    ...
    if args.test_candidatelist_get is True:
        print("--------------Testing CandidateList GET method is {}---------------".format(
            args.test_candidatelist_get))
        test_candidatelist_get_method()
        print("---------------------------------------------------------------------")
    if args.test_candidatelist_post is True:
        print("--------------Testing CandidateList POST method is {}--------------".format(
            args.test_candidatelist_post))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_candidatelist_get",
                        help="test get method", action='store_true', default='false')
    parser.add_argument("--test_candidatelist_post",
                        help="test post method", action='store_true', default='false')
    parser.add_argument("--test_candidate_get", help="test get method",
                        action='store_true', default='false')
    parser.add_argument("--test_candidate_put", help="test put method",
                        action='store_true', default='false')
    parser.add_argument("--test_candidate_delete",
                        help="test delete method", action='store_true', default='false')
    parser.add_argument(
        "--candidate_id", help="candidate id", type=int, default=None)
